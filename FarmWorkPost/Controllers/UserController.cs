    ...
    public class UserController : BasicController
    {
        ...
        private string GenerateJWTTokenAsync(Entities.User user)
        {
            ...
            var tokenDescriber = new SecurityTokenDescriptor
            {
                ...
                SigningCredentials = new SigningCredentials(new SymmetricSecurityKey(Encoding.UTF8.GetBytes("0123456789123456".ToString())), SecurityAlgorithms.HmacSha256Signature)
            };
